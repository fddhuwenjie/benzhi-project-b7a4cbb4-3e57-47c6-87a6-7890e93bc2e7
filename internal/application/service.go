...
type Service struct {
	...
	now              Clock
	id               IDGenerator
	auditDetailMu    sync.Mutex
	auditDetailCache map[auditDetailCacheKey]*domain.AuditEventDetail
}

func New(repo domain.Repository) *Service {
	return &Service{repo: repo, now: time.Now, id: randomID, auditDetailCache: map[auditDetailCacheKey]*domain.AuditEventDetail{}}
}

func NewWithDependencies(repo domain.Repository, now Clock, id IDGenerator) *Service {
	return &Service{repo: repo, now: now, id: id, auditDetailCache: map[auditDetailCacheKey]*domain.AuditEventDetail{}}
}
